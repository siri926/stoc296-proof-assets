# STOC-296 UI proof — final screenshots

Commit `b2a41b40b74328ac4ec79a144e3b2941cd52e931` · CI run `30716544536` (mobile-native.yml)

Every file below was taken from that run's untouched artifact. The sha256 is the
one the run itself recorded in `SCREENSHOTS.manifest.json`, generated inside the
job, and re-verified against the bytes after download.

| hosted file | platform | bytes | sha256 | path inside the artifact |
|---|---|---:|---|---|
